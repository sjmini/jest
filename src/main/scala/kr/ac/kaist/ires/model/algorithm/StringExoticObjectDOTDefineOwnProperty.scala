...
object StringExoticObjectDOTDefineOwnProperty {
  val length: Int = 2
  val func: Func = Func("""StringExoticObject.DefineOwnProperty""", List(Id("""S"""), Id("""P"""), Id("""Desc""")), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefId(Id("""StringGetOwnProperty"""))), List(ERef(RefId(Id("""S"""))), ERef(RefId(Id("""P"""))))).setId(54955), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x0__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x0__""")), ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Value""")))).setId(54956), IReturn(ERef(RefId(Id("""__x0__""")))).setId(54957)).setId(54958), ISeq(List()).setId(54988)).setId(54959), ILet(Id("""stringDesc"""), ERef(RefId(Id("""__x0__""")))).setId(54960), IIf(EUOp(ONot, EBOp(OEq, ERef(RefId(Id("""stringDesc"""))), EUndef)), ISeq(List(ILet(Id("""extensible"""), ERef(RefProp(RefId(Id("""S""")), EStr("""Extensible""")))).setId(54962), IApp(Id("""__x1__"""), ERef(RefId(Id("""IsCompatiblePropertyDescriptor"""))), List(ERef(RefId(Id("""extensible"""))), ERef(RefId(Id("""Desc"""))), ERef(RefId(Id("""stringDesc"""))))).setId(54964), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(54965), IReturn(ERef(RefId(Id("""__x1__""")))).setId(54966)).setId(54967), ISeq(List()).setId(54996)).setId(54968), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))).setId(54969), IReturn(ERef(RefId(Id("""__x2__""")))).setId(54970))).setId(55000), ISeq(List()).setId(55001)).setId(54973), IApp(Id("""__x3__"""), ERef(RefId(Id("""OrdinaryDefineOwnProperty"""))), List(ERef(RefId(Id("""S"""))), ERef(RefId(Id("""P"""))), ERef(RefId(Id("""Desc"""))))).setId(54975), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x3__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x3__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x3__""")), ERef(RefProp(RefId(Id("""__x3__""")), EStr("""Value""")))).setId(54976), IReturn(ERef(RefId(Id("""__x3__""")))).setId(54977)).setId(54978), ISeq(List()).setId(55007)).setId(54979), IApp(Id("""__x4__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x3__"""))))).setId(54980), IReturn(ERef(RefId(Id("""__x4__""")))).setId(54981))).setId(55011))
  val instToStepMap: Map[Int, Int] = HashMap(54973 -> 6, 54960 -> 1, 54963 -> 5, 54974 -> 6, 54971 -> 5, 54962 -> 5, 54979 -> 7, 54961 -> 1, 54954 -> 0, 54968 -> 5, 54972 -> 5, 54970 -> 5, 54955 -> 1, 54980 -> 7, 54982 -> 7, 54975 -> 7, 54981 -> 7, 54969 -> 5, 54964 -> 5, 54959 -> 1)
  val stepToInstsMap: Map[Int, HashSet[Int]] = HashMap(0 -> HashSet(54954), 5 -> HashSet(54970, 54963, 54971, 54962, 54969, 54964, 54968, 54972), 1 -> HashSet(54960, 54955, 54961, 54959), 6 -> HashSet(54973, 54974), 7 -> HashSet(54980, 54979, 54981, 54982, 54975), 4 -> HashSet(54963, 54962))
  /* Beautified form:
