...
object VariableDeclarationList1BoundNames0 {
  val length: Int = 0
  val func: Func = Func("""VariableDeclarationList1BoundNames0""", List(Id("""this"""), Id("""VariableDeclarationList"""), Id("""VariableDeclaration""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""VariableDeclarationList"""))), EStr("""BoundNames""")).setId(27431), ILet(Id("""names"""), ERef(RefId(Id("""__x0__""")))).setId(27432), IAccess(Id("""__x1__"""), ERef(RefId(Id("""VariableDeclaration"""))), EStr("""BoundNames""")).setId(27434), ILet(Id("""__x2__"""), ERef(RefId(Id("""__x1__""")))).setId(27436), ILet(Id("""__x3__"""), EINum(0L)).setId(27437), IWhile(EBOp(OLt, ERef(RefId(Id("""__x3__"""))), ERef(RefProp(RefId(Id("""__x2__""")), EStr("""length""")))), ISeq(List(ILet(Id("""__x4__"""), ERef(RefProp(RefId(Id("""__x2__""")), ERef(RefId(Id("""__x3__""")))))).setId(27438), IAppend(ERef(RefId(Id("""__x4__"""))), ERef(RefId(Id("""names""")))).setId(27435), IAssign(RefId(Id("""__x3__""")), EBOp(OPlus, ERef(RefId(Id("""__x3__"""))), EINum(1L))).setId(27439))).setId(27440)).setId(27441), IReturn(ERef(RefId(Id("""names""")))).setId(27444))).setId(-1))
  /* Beautified form:
