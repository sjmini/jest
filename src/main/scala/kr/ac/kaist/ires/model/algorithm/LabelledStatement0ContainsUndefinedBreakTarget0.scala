...
object LabelledStatement0ContainsUndefinedBreakTarget0 {
  val length: Int = 0
  val func: Func = Func("""LabelledStatement0ContainsUndefinedBreakTarget0""", List(Id("""this"""), Id("""LabelIdentifier"""), Id("""LabelledItem"""), Id("""labelSet""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""LabelIdentifier"""))), EStr("""StringValue""")).setId(36188), ILet(Id("""label"""), ERef(RefId(Id("""__x0__""")))).setId(36189), ILet(Id("""__x1__"""), ECopy(ERef(RefId(Id("""labelSet"""))))).setId(36191), IAppend(ERef(RefId(Id("""label"""))), ERef(RefId(Id("""__x1__""")))).setId(36192), ILet(Id("""newLabelSet"""), ERef(RefId(Id("""__x1__""")))).setId(36193), IAccess(Id("""__x2__"""), ERef(RefId(Id("""LabelledItem"""))), EStr("""ContainsUndefinedBreakTarget""")).setId(36195), IApp(Id("""__x3__"""), ERef(RefId(Id("""__x2__"""))), List(ERef(RefId(Id("""newLabelSet"""))))).setId(36196), IReturn(ERef(RefId(Id("""__x3__""")))).setId(36197))).setId(-1))
  /* Beautified form:
