...
object LengthOfArrayLike {
  val length: Int = 1
  val func: Func = Func("""LengthOfArrayLike""", List(Id("""obj""")), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefId(Id("""Get"""))), List(ERef(RefId(Id("""obj"""))), EStr("""length"""))).setId(6008), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x0__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x0__""")), ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Value""")))).setId(6009), IReturn(ERef(RefId(Id("""__x0__""")))).setId(6010)).setId(6011), ISeq(List()).setId(6007)).setId(6012), IApp(Id("""__x1__"""), ERef(RefId(Id("""ToLength"""))), List(ERef(RefId(Id("""__x0__"""))))).setId(6013), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(6014), IReturn(ERef(RefId(Id("""__x1__""")))).setId(6015)).setId(6016), ISeq(List()).setId(6007)).setId(6017), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))).setId(6018), IReturn(ERef(RefId(Id("""__x2__""")))).setId(6019))).setId(-1))
  /* Beautified form:
