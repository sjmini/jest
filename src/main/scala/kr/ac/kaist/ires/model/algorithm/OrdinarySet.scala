...
object OrdinarySet {
  val length: Int = 4
  val func: Func = Func("""OrdinarySet""", List(Id("""O"""), Id("""P"""), Id("""V"""), Id("""Receiver""")), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefProp(RefId(Id("""O""")), EStr("""GetOwnProperty"""))), List(ERef(RefId(Id("""O"""))), ERef(RefId(Id("""P"""))))).setId(50545), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x0__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x0__""")), ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Value""")))).setId(50546), IReturn(ERef(RefId(Id("""__x0__""")))).setId(50547)).setId(50548), ISeq(List()).setId(50561)).setId(50549), ILet(Id("""ownDesc"""), ERef(RefId(Id("""__x0__""")))).setId(50550), IApp(Id("""__x1__"""), ERef(RefId(Id("""OrdinarySetWithOwnDescriptor"""))), List(ERef(RefId(Id("""O"""))), ERef(RefId(Id("""P"""))), ERef(RefId(Id("""V"""))), ERef(RefId(Id("""Receiver"""))), ERef(RefId(Id("""ownDesc"""))))).setId(50552), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))).setId(50553), IReturn(ERef(RefId(Id("""__x2__""")))).setId(50554))).setId(50567))
  val instToStepMap: Map[Int, Int] = HashMap(50549 -> 1, 50545 -> 1, 50550 -> 1, 50553 -> 2, 50555 -> 2, 50551 -> 1, 50552 -> 2, 50554 -> 2, 50544 -> 0)
  val stepToInstsMap: Map[Int, HashSet[Int]] = Map(0 -> HashSet(50544), 1 -> HashSet(50549, 50545, 50550, 50551), 2 -> HashSet(50554, 50553, 50555, 50552))
  /* Beautified form:
