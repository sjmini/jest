...
object IfStatement0StatementRules0 {
  val length: Int = 0
  val func: Func = Func("""IfStatement0StatementRules0""", List(Id("""this"""), Id("""Expression"""), Id("""Statement""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""Statement"""))), EStr("""HasCallInTailPosition""")).setId(44967), IApp(Id("""__x1__"""), ERef(RefId(Id("""__x0__"""))), List(ERef(RefId(Id("""call"""))))).setId(44968), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))).setId(44969), IReturn(ERef(RefId(Id("""__x2__""")))).setId(44970))).setId(-1))
  /* Beautified form:
