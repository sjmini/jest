...
object FormalParameterList1IteratorBindingInitialization0 {
  val length: Int = 0
  val func: Func = Func("""FormalParameterList1IteratorBindingInitialization0""", List(Id("""this"""), Id("""FormalParameterList"""), Id("""FormalParameter"""), Id("""iteratorRecord"""), Id("""environment""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""FormalParameterList"""))), EStr("""IteratorBindingInitialization""")).setId(38220), IApp(Id("""__x1__"""), ERef(RefId(Id("""__x0__"""))), List(ERef(RefId(Id("""iteratorRecord"""))), ERef(RefId(Id("""environment"""))))).setId(38221), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(38222), IReturn(ERef(RefId(Id("""__x1__""")))).setId(38223)).setId(38224), ISeq(List()).setId(38240)).setId(38226), IExpr(ERef(RefId(Id("""__x1__""")))).setId(38227), IAccess(Id("""__x2__"""), ERef(RefId(Id("""FormalParameter"""))), EStr("""IteratorBindingInitialization""")).setId(38229), IApp(Id("""__x3__"""), ERef(RefId(Id("""__x2__"""))), List(ERef(RefId(Id("""iteratorRecord"""))), ERef(RefId(Id("""environment"""))))).setId(38230), IApp(Id("""__x4__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x3__"""))))).setId(38231), IReturn(ERef(RefId(Id("""__x4__""")))).setId(38232))).setId(38247))
  val instToStepMap: Map[Int, Int] = HashMap(38227 -> 0, 38220 -> 0, 38231 -> 1, 38221 -> 0, 38226 -> 0, 38230 -> 1, 38229 -> 1, 38232 -> 1, 38233 -> 1, 38228 -> 0)
  val stepToInstsMap: Map[Int, HashSet[Int]] = Map(0 -> HashSet(38227, 38220, 38221, 38226, 38228), 1 -> HashSet(38231, 38230, 38229, 38233, 38232))
  /* Beautified form:
