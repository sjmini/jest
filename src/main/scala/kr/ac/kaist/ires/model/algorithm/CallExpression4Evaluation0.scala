...
object CallExpression4Evaluation0 {
  val length: Int = 0
  val func: Func = Func("""CallExpression4Evaluation0""", List(Id("""this"""), Id("""MemberExpression"""), Id("""Expression""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""MemberExpression"""))), EStr("""Evaluation""")).setId(16525), ILet(Id("""baseReference"""), ERef(RefId(Id("""__x0__""")))).setId(16526), IApp(Id("""__x1__"""), ERef(RefId(Id("""GetValue"""))), List(ERef(RefId(Id("""baseReference"""))))).setId(16528), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(16529), IReturn(ERef(RefId(Id("""__x1__""")))).setId(16530)).setId(16531), ISeq(List()).setId(16577)).setId(16533), ILet(Id("""baseValue"""), ERef(RefId(Id("""__x1__""")))).setId(16534), IAccess(Id("""__x2__"""), ERef(RefId(Id("""Expression"""))), EStr("""Evaluation""")).setId(16537), ILet(Id("""propertyNameReference"""), ERef(RefId(Id("""__x2__""")))).setId(16538), IApp(Id("""__x3__"""), ERef(RefId(Id("""GetValue"""))), List(ERef(RefId(Id("""propertyNameReference"""))))).setId(16540), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x3__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x3__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x3__""")), ERef(RefProp(RefId(Id("""__x3__""")), EStr("""Value""")))).setId(16541), IReturn(ERef(RefId(Id("""__x3__""")))).setId(16542)).setId(16543), ISeq(List()).setId(16586)).setId(16544), ILet(Id("""propertyNameValue"""), ERef(RefId(Id("""__x3__""")))).setId(16545), IApp(Id("""__x4__"""), ERef(RefId(Id("""RequireObjectCoercible"""))), List(ERef(RefId(Id("""baseValue"""))))).setId(16547), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x4__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x4__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x4__""")), ERef(RefProp(RefId(Id("""__x4__""")), EStr("""Value""")))).setId(16548), IReturn(ERef(RefId(Id("""__x4__""")))).setId(16549)).setId(16550), ISeq(List()).setId(16593)).setId(16551), ILet(Id("""bv"""), ERef(RefId(Id("""__x4__""")))).setId(16552), IApp(Id("""__x5__"""), ERef(RefId(Id("""ToPropertyKey"""))), List(ERef(RefId(Id("""propertyNameValue"""))))).setId(16554), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x5__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x5__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x5__""")), ERef(RefProp(RefId(Id("""__x5__""")), EStr("""Value""")))).setId(16555), IReturn(ERef(RefId(Id("""__x5__""")))).setId(16556)).setId(16557), ISeq(List()).setId(16600)).setId(16558), ILet(Id("""propertyKey"""), ERef(RefId(Id("""__x5__""")))).setId(16559), IIf(EBool(true), ILet(Id("""strict"""), EBool(true)).setId(16561), ILet(Id("""strict"""), EBool(false)).setId(16563)).setId(16565), IApp(Id("""__x6__"""), ERef(RefId(Id("""WrapCompletion"""))), List(EMap(Ty("""Reference"""), List((EStr("""BaseValue"""), ERef(RefId(Id("""bv""")))), (EStr("""ReferencedName"""), ERef(RefId(Id("""propertyKey""")))), (EStr("""StrictReference"""), ERef(RefId(Id("""strict""")))))))).setId(16567), IReturn(ERef(RefId(Id("""__x6__""")))).setId(16568))).setId(16608))
  val instToStepMap: Map[Int, Int] = HashMap(16566 -> 6, 16552 -> 4, 16534 -> 1, 16560 -> 5, 16569 -> 7, 16553 -> 4, 16535 -> 1, 16554 -> 5, 16533 -> 1, 16559 -> 5, 16540 -> 3, 16545 -> 3, 16527 -> 0, 16544 -> 3, 16562 -> 6, 16565 -> 6, 16568 -> 7, 16551 -> 4, 16561 -> 6, 16528 -> 1, 16537 -> 2, 16567 -> 7, 16538 -> 2, 16525 -> 0, 16564 -> 6, 16547 -> 4, 16558 -> 5, 16526 -> 0, 16539 -> 2, 16563 -> 6, 16546 -> 3)
  val stepToInstsMap: Map[Int, HashSet[Int]] = HashMap(0 -> HashSet(16527, 16525, 16526), 5 -> HashSet(16559, 16560, 16554, 16558), 1 -> HashSet(16533, 16534, 16528, 16535), 6 -> HashSet(16566, 16561, 16564, 16563, 16562, 16565), 2 -> HashSet(16537, 16538, 16539), 7 -> HashSet(16569, 16568, 16567), 3 -> HashSet(16544, 16546, 16540, 16545), 4 -> HashSet(16552, 16551, 16553, 16547))
  /* Beautified form:
