...
object IterationStatement11LabelledEvaluation0 {
  val length: Int = 0
  val func: Func = Func("""IterationStatement11LabelledEvaluation0""", List(Id("""this"""), Id("""LeftHandSideExpression"""), Id("""AssignmentExpression"""), Id("""Statement"""), Id("""labelSet""")), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefId(Id("""ForInOfHeadEvaluation"""))), List(EList(List()), ERef(RefId(Id("""AssignmentExpression"""))), ERef(RefId(Id("""CONST_asynciterate"""))))).setId(32950), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x0__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x0__""")), ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Value""")))).setId(32951), IReturn(ERef(RefId(Id("""__x0__""")))).setId(32952)).setId(32953), ISeq(List()).setId(32954)).setId(32955), ILet(Id("""keyResult"""), ERef(RefId(Id("""__x0__""")))).setId(32956), IApp(Id("""__x1__"""), ERef(RefId(Id("""ForInOfBodyEvaluation"""))), List(ERef(RefId(Id("""LeftHandSideExpression"""))), ERef(RefId(Id("""Statement"""))), ERef(RefId(Id("""keyResult"""))), ERef(RefId(Id("""CONST_iterate"""))), ERef(RefId(Id("""CONST_assignment"""))), ERef(RefId(Id("""labelSet"""))), ERef(RefId(Id("""CONST_async"""))))).setId(32958), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(32959), IReturn(ERef(RefId(Id("""__x1__""")))).setId(32960)).setId(32961), ISeq(List()).setId(32954)).setId(32962), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))).setId(32963), IReturn(ERef(RefId(Id("""__x2__""")))).setId(32964))).setId(-1))
  /* Beautified form:
