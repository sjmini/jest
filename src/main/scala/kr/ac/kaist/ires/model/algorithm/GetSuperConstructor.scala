...
object GetSuperConstructor {
  val length: Int = 0
  val func: Func = Func("""GetSuperConstructor""", List(), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefId(Id("""GetThisEnvironment"""))), List()).setId(17865), ILet(Id("""envRec"""), ERef(RefId(Id("""__x0__""")))).setId(17866), ILet(Id("""activeFunction"""), ERef(RefProp(RefId(Id("""envRec""")), EStr("""FunctionObject""")))).setId(17869), IApp(Id("""__x1__"""), ERef(RefProp(RefId(Id("""activeFunction""")), EStr("""GetPrototypeOf"""))), List(ERef(RefId(Id("""activeFunction"""))))).setId(17871), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))).setId(17872), IReturn(ERef(RefId(Id("""__x1__""")))).setId(17873)).setId(17874), ISeq(List()).setId(17895)).setId(17875), ILet(Id("""superConstructor"""), ERef(RefId(Id("""__x1__""")))).setId(17876), IApp(Id("""__x2__"""), ERef(RefId(Id("""IsConstructor"""))), List(ERef(RefId(Id("""superConstructor"""))))).setId(17878), IIf(EBOp(OEq, ERef(RefId(Id("""__x2__"""))), EBool(false)), ISeq(List(IApp(Id("""__x3__"""), ERef(RefId(Id("""ThrowCompletion"""))), List(EMap(Ty("""OrdinaryObject"""), List((EStr("""Prototype"""), ERef(RefId(Id("""INTRINSIC_TypeErrorPrototype""")))), (EStr("""ErrorData"""), EUndef), (EStr("""SubMap"""), EMap(Ty("""SubMap"""), List())))))).setId(17879), IReturn(ERef(RefId(Id("""__x3__""")))).setId(17880))).setId(17901), ISeq(List()).setId(17902)).setId(17882), IApp(Id("""__x4__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""superConstructor"""))))).setId(17884), IReturn(ERef(RefId(Id("""__x4__""")))).setId(17885))).setId(17906))
  val instToStepMap: Map[Int, Int] = HashMap(17875 -> 4, 17871 -> 4, 17867 -> 0, 17884 -> 7, 17879 -> 5, 17866 -> 0, 17876 -> 4, 17870 -> 2, 17883 -> 6, 17880 -> 5, 17882 -> 6, 17865 -> 0, 17886 -> 7, 17869 -> 2, 17877 -> 4, 17881 -> 5, 17885 -> 7, 17868 -> 3, 17878 -> 6)
  val stepToInstsMap: Map[Int, HashSet[Int]] = HashMap(0 -> HashSet(17867, 17866, 17865), 5 -> HashSet(17879, 17880, 17881), 1 -> HashSet(17868), 6 -> HashSet(17883, 17882, 17878), 2 -> HashSet(17870, 17869), 7 -> HashSet(17884, 17886, 17885), 3 -> HashSet(17868), 4 -> HashSet(17875, 17871, 17876, 17877))
  /* Beautified form:
  "GetSuperConstructor" () => {
