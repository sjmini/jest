...
object AssignmentProperty1PropertyDestructuringAssignmentEvaluation0 {
  val length: Int = 0
  val func: Func = Func("""AssignmentProperty1PropertyDestructuringAssignmentEvaluation0""", List(Id("""this"""), Id("""PropertyName"""), Id("""AssignmentElement"""), Id("""value""")), None, ISeq(List(IAccess(Id("""__x0__"""), ERef(RefId(Id("""PropertyName"""))), EStr("""Evaluation""")).setId(24485), ILet(Id("""name"""), ERef(RefId(Id("""__x0__""")))).setId(24486), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""name""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""name""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""name""")), ERef(RefProp(RefId(Id("""name""")), EStr("""Value""")))).setId(24488), IReturn(ERef(RefId(Id("""name""")))).setId(24489)).setId(24490), ISeq(List()).setId(24512)).setId(24492), IExpr(ERef(RefId(Id("""name""")))).setId(24493), IAccess(Id("""__x1__"""), ERef(RefId(Id("""AssignmentElement"""))), EStr("""KeyedDestructuringAssignmentEvaluation""")).setId(24495), IApp(Id("""__x2__"""), ERef(RefId(Id("""__x1__"""))), List(ERef(RefId(Id("""value"""))), ERef(RefId(Id("""name"""))))).setId(24496), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x2__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x2__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x2__""")), ERef(RefProp(RefId(Id("""__x2__""")), EStr("""Value""")))).setId(24497), IReturn(ERef(RefId(Id("""__x2__""")))).setId(24498)).setId(24499), ISeq(List()).setId(24520)).setId(24500), IExpr(ERef(RefId(Id("""__x2__""")))).setId(24501), IApp(Id("""__x3__"""), ERef(RefId(Id("""WrapCompletion"""))), List(EList(List(ERef(RefId(Id("""name"""))))))).setId(24503), IReturn(ERef(RefId(Id("""__x3__""")))).setId(24504))).setId(24525))
  val instToStepMap: Map[Int, Int] = HashMap(24501 -> 2, 24494 -> 1, 24505 -> 3, 24487 -> 0, 24503 -> 3, 24492 -> 1, 24485 -> 0, 24500 -> 2, 24486 -> 0, 24496 -> 2, 24502 -> 2, 24493 -> 1, 24504 -> 3, 24495 -> 2)
  val stepToInstsMap: Map[Int, HashSet[Int]] = Map(0 -> HashSet(24486, 24487, 24485), 1 -> HashSet(24494, 24493, 24492), 2 -> HashSet(24501, 24496, 24502, 24495, 24500), 3 -> HashSet(24505, 24503, 24504))
  /* Beautified form:
